...
parser.add_argument('--checkpoint_dir', type=str, default='./ckpnt_center')
...
def main():
    ...
    criterion_crossentropy = torch.nn.CrossEntropyLoss().cuda()
    criterion_center = CenterLoss(num_classes=num_class, feat_dim=embedding_dim).cuda()
    
    params = list(model.parameters()) + list(criterion_center.parameters())
    ...
    for epoch in range(epochs):
        ...
        for batch_index, (data, labels) in enumerate(train_loader):
            ...
            loss = criterion_center(embedding, labels.cuda())
